...
namespace Acquisition.Api.Client
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface IAcquisitionApiClient
    {
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetSimulatorInformationResponseDto> GetSimulatorInformationAsync();
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetLoanOffersResponseDto> GetLoanOffersAsync(GetLoanOffersQuery getLoanOffersQuery, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task SignContractAsync(SignContractCommand signContractCommand);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task SignContractAsync(SignContractCommand signContractCommand, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ChooseALoanOfferAsync(ChooseALoanOfferCommand chooseALoanOfferCommand);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ChooseALoanOfferAsync(ChooseALoanOfferCommand chooseALoanOfferCommand, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ExpressLoanWishResponseDto> ExpressLoanWishAsync(ExpressLoanWishCommand expressLoanWishCommand);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ExpressLoanWishResponseDto> ExpressLoanWishAsync(ExpressLoanWishCommand expressLoanWishCommand, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task UpdateUserInformationAsync(UpdateUserInformationCommand updateUserInformationCommand);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task UpdateUserInformationAsync(UpdateUserInformationCommand updateUserInformationCommand, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AcquisitionApiClient : IAcquisitionApiClient
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public AcquisitionApiClient(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetSimulatorInformationResponseDto> GetSimulatorInformationAsync()
        {
            return GetSimulatorInformationAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetSimulatorInformationResponseDto> GetSimulatorInformationAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "get-simulator-information"
                    urlBuilder_.Append("get-simulator-information");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetSimulatorInformationResponseDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetLoanOffersResponseDto> GetLoanOffersAsync(GetLoanOffersQuery getLoanOffersQuery)
        {
            return GetLoanOffersAsync(getLoanOffersQuery, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetLoanOffersResponseDto> GetLoanOffersAsync(GetLoanOffersQuery getLoanOffersQuery, System.Threading.CancellationToken cancellationToken)
        {
            if (getLoanOffersQuery == null)
                throw new System.ArgumentNullException("getLoanOffersQuery");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(getLoanOffersQuery, JsonSerializerSettings);
                    var content_ = new System.Net.Http.ByteArrayContent(json_);
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "get-loan-offers"
                    urlBuilder_.Append("get-loan-offers");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetLoanOffersResponseDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcquisitionApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task UpdateUserInformationAsync(UpdateUserInformationCommand updateUserInformationCommand)
        {
            return UpdateUserInformationAsync(updateUserInformationCommand, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="AcquisitionApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UpdateUserInformationAsync(UpdateUserInformationCommand updateUserInformationCommand, System.Threading.CancellationToken cancellationToken)
        {
            if (updateUserInformationCommand == null)
                throw new System.ArgumentNullException("updateUserInformationCommand");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(updateUserInformationCommand, JsonSerializerSettings);
                    var content_ = new System.Net.Http.ByteArrayContent(json_);
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "update-user-information"
                    urlBuilder_.Append("update-user-information");
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                catch (System.Text.Json.JsonException exception)
                {
                    ...
                    throw new AcquisitionApiException(message, (int)response.StatusCode, responseText, headers, exception);
                }
            }
            else
            {
                ...
                catch (System.Text.Json.JsonException exception)
                {
                    ...
                    throw new AcquisitionApiException(message, (int)response.StatusCode, string.Empty, headers, exception);
                }
            }
        }
    ...
    public partial class GetSimulatorInformationResponseDto
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class EvaluateEligibilityToALoanResponseDto
    {

        [System.Text.Json.Serialization.JsonPropertyName("isEligibleToALoan")]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetLoanOffersResponseDto
    {

        [System.Text.Json.Serialization.JsonPropertyName("loanOffers")]
        public System.Collections.Generic.ICollection<LoanOfferDto> LoanOffers { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class LoanOfferDto
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetLoanOffersQuery
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class UpdateUserInformationCommand
    {

        [System.Text.Json.Serialization.JsonPropertyName("loanApplicationId")]
        public System.Guid LoanApplicationId { get; set; }

        [System.Text.Json.Serialization.JsonPropertyName("updatedProperties")]
        public System.Collections.Generic.IDictionary<string, object> UpdatedProperties { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AcquisitionApiException : System.Exception
    {
        ...
        public AcquisitionApiException(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Exception innerException)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AcquisitionApiException<TResult> : AcquisitionApiException
    {
        public TResult Result { get; private set; }

        public AcquisitionApiException(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, TResult result, System.Exception innerException)
